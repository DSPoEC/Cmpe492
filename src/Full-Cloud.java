...
//               1);
	   ...
	   builder.setBolt("cloud-SenMlParseBolt",
...
//		            .shuffleGrouping("spout10");
        ...
        builder.setBolt("cloud-RangeFilterBolt",
	                new RangeFilterBolt(p_), 1)
	                .fieldsGrouping("cloud-SenMlParseBolt", new Fields("OBSTYPE"));

		 builder.setBolt("cloud-BloomFilterBolt",
	                new BloomFilterCheckBolt(p_), 1)
	                .fieldsGrouping("cloud-RangeFilterBolt", new Fields("OBSTYPE"));
		 
		 builder.setBolt("cloud-InterpolationBolt",
	                new InterpolationBolt(p_), 1)
	                .fieldsGrouping("cloud-BloomFilterBolt", new Fields("OBSTYPE"));
